...
public class MySecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception{
        http
                ...
                .disable()
                .authorizeRequests()
                .antMatchers("/register","/achievements","/getAchievements","/login-admin","/refresh-token","/add-product","/excel/products","/get-products","/getProducts/{model}","/description/{modelNumber}","/additionalfeatures/{modelNumber}","/login-admin","/add-solution","/solutions","/solutionfeatures/{title}","/solutionbenefits/{title}","/solcategory","/getsolcategory","/getsolcategorydetail","/productcategory","/getproductcategory","/getSolutions/{title}","/getProducts/{model}","/navbar","/getNavbar","/homecover","/gethomecover").permitAll() //one doubt of image returning
