...
public class MySecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception{
        http
                ...
                .disable()
                .authorizeRequests()
                .antMatchers("/register","/add-product","/excel/products","/get-products","/login-admin","/solutions","/getsolcategory","/getsolcategorydetail","/getproductcategory").permitAll() //one doubt of image returning
